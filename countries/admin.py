...
class CountryAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        (None, {
                'fields': [
                    'name', 'slug', 'conventional_long_name',
                    'local_long_name', 'local_short_name', 'capital_name',
                    'continent', 'anthem', 'motto', 'official_language',
                    'national_language', 'internet_tld', 'currency_name',
                    'currency_code', 'currency_simbol', 'iso_code_a2',
